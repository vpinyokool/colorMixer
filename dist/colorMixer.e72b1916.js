...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // Import color extraction functions
/**
 * Color Mixer Module
...
var ColorMixer = {
  ...
  utils: {
    ...
    getCorsUrl: function getCorsUrl(url) {
      ...
      var corsProxies = ["https://api.allorigins.win/raw?url=".concat(encodeURIComponent(url)), "https://cors-anywhere.herokuapp.com/".concat(url)];
  ...
  ui: {
    ...
    updateBackgroundImage: function updateBackgroundImage() {
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var imgUrl, img, useProxy, imageUrl, dominantColor, hexColor;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              imgUrl = $("#imgInput").val();
            ...
            case 5:
              ...
              useProxy = ColorMixer.utils.isPinterestUrl(imgUrl);
              imageUrl = useProxy ? ColorMixer.utils.getCorsUrl(imgUrl) : imgUrl; // Load the image
              _context.next = 13;
            ...
            case 13:
              ...
              _context.next = 16;
              return (0, _colorExtractor.getImageDominantColor)(imageUrl);
            case 16:
